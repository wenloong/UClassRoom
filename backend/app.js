...
// var randomCode = "abcde";
//
// const session_aaa = io.of("/session-" + randomCode)
//   .on('connection', function(socket) {
//     console.log("Someone connected to " + randomCode + "!");
//   })
//   .on('session vote', function (user, choice) {
//     console.log(user + " voted for some choice! (" + choice + ")");
//   })
//   .on('session join', function (user) {
//     console.log(user + " joined the session!");
...
//   })
//   .on('disconnect', function () {
//     console.log("Someone left " + randomCode + "!");
//   });
// sessionMap.set("aaa", session_aaa);